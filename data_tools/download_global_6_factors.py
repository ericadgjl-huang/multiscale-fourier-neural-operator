...
for year in years:
    # 動態產生檔名，例如 global_era5_6_factors_2021.nc
    filename = f'data/global_era5_6_factors_{year}.nc'
        ...
        c.retrieve(
            'reanalysis-era5-single-levels',
            {
                ...
                'variable': [
                    ...
                    # 新增的 2 個垂直積分變數
                    'vertical_integral_of_divergence_of_moisture_flux', # 垂直積分水分散度
                    'vertical_integral_of_total_energy'                # 總能量的垂直積分
                ],
